...
public class InstructionProcessor {
	...
	public void executeBEQ(ITypeInstruction instruction) {
		RegisterFile regFile = RegisterFile.getInstance();
	...
	public void executeBGEZ(Instruction instruction) { 
	...
	public void executeBGEZAL(Instruction instruction) { 
	...
	public void executeBGTZ(Instruction instruction) { 
	...
	public void executeBLEZ(Instruction instruction) { 
	...
	public void executeBLTZ(Instruction instruction) { 
	...
	public void executeBLTZAL(Instruction instruction) { 
	...
	public void executeDIVU(Instruction instruction) { 
		/* -- Divide unsigned
	...
	public void executeJ(JTypeInstruction instruction) {
	...
	public void executeJAL(JTypeInstruction instruction) { 
		RegisterFile regfile = RegisterFile.getInstance();
	...
	public void executeLB(ITypeInstruction instruction) {
		...
		int value=memory.getMemoryValue(regfile.getRegisterValue(instruction.getRegSource()
				+instruction.getImmediateVal()));
	...
	public void executeLUI(ITypeInstruction instruction) {
		...
		int value=memory.getMemoryValue(instruction.getImmediateVal() << 16);
	...
	public void executeMFHI(Instruction instruction) { 
		/* -- Move from HI
	...
	public void executeMFLO (Instruction instruction) { 
		/*-- Move from LO
	...
	public void executeMULT(Instruction instruction) { 
		/* -- Multiply
	...
	public void executeMULTU(Instruction instruction) { 
		/* -- Multiply unsigned
	...
	public void executeSB(ITypeInstruction instruction) { 
		...
		int value = regFile.getRegisterValue(instruction.getRegSource()) & 0xff ;
		memory.setMemoryValue( regFile.getRegisterValue(instruction.getRegTarget())
...
/*
	...
	public void executeSLTI(ITypeInstruction instruction) {
		RegisterFile regFile = RegisterFile.getInstance();
		if(regFile.getRegisterValue(instruction.getRegSource()) <
				regFile.getRegisterValue(instruction.getImmediateVal())){
			regFile.setRegisterValue(instruction.getRegTarget(), 1);
		}else{
			regFile.setRegisterValue(instruction.getRegTarget(), 0);
		}
	...
	public void executeSW(ITypeInstruction instruction) { 
		...
		memory.setMemoryValue( regFile.getRegisterValue(instruction.getRegSource())
				+instruction.getImmediateVal(), value);
		AppContext.PROGRAM_COUNTER++;	
		/* -- Store word
	...
	public void executeSYSCALL(Instruction instruction) {
		//incorrect
